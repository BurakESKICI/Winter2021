...
public class C2_WhileLoop {
	...
	public static void main(String[] args) {
		...
		// while : iken, oldugu sürece anlamýna gelir
		// 10'dan 30'a kadar olan sayýlardan 4 ile bölünebilenleri
		//aralarýnda bir bosluk olacak sekýlde yanyana yazdirin
		
		//önce for loop ile yapalim
