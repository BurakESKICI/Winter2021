...
public class Scope1 {
	...
	public void method() {
		...
		System.out.println(sayi); // bu method static olmadýgý ýcýn ýnstance variable lere direk olarak ulasabýlýr
		sayi = sayi + 20; // ve bu method ýcerýsýnde gecerlý olmak uzere degerini degistirebilir
	}
}
